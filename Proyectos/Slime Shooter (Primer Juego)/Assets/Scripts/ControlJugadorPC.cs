...
public class ControlJugadorPC : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Jump") && _tocandoSuelo == true && _Atacando == false) 
		{
            contadorDeDisparos = 0;
        ...
        else if (Input.GetButtonDown("Jump") && _tocandoSuelo == false && contadorDeSaltos < 2 && contadorDeSaltos != 0 && _Atacando == false)
        {
        ...
        if (Input.GetButtonDown("Fire1") && _tocandoSuelo == true && _Atacando == false) 
        {
